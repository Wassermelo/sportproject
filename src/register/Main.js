...
function Main() {
    const [nvLogin, setnvLogin] = useState(true);
    const onLoginF = () => {
        setnvLogin(true);
    }
    const onNavBar = () => {
   ...
   const location = useLocation();
    ...
    useEffect(() => {
        ...
        if(location && location.search && location.search.indexOf("code") !== -1) {
            localStorage.setItem('url', location.search);
        }
    }, [location]);
            ...
            <div className="App">
                ...
                <div className="auth-wrapper">
                       <Routes>
                            ...
                            <Route path='/lime/control' element={
                                <RolesRoute roles={['sport_admin']}>
                                    <div className="auth-inner"> <LimeControl/></div>
                                </RolesRoute> } />
